...
export default function Chart({result}:{result:CalculationResult}){
 ...
 const rows:[keyof typeof d[number],string,string,ProfileInput|undefined][]=[["plan_y","平面 y","m",getProfile("平面线形")],["elevation_y","立面 y","m",getProfile("立面线形")],["stress","应力","MPa",undefined],["elongation_mm","伸长量","mm",undefined]];
